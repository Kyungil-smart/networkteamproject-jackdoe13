...
- Is Kinematic
1. 물리엔진 사용 여부
2. OFF 체크: 중력, AddForce, 충돌 반응 등 기본 물리 기능 요소를 사용
3. On 체크: 물리기능을 스크립트로 구현하여 사용 
    ```csharp
    transform.position
    ```
- AddTorque()
...
![alt text](<스크린샷 2026-05-27 130419.png>)
...
![alt text](<스크린샷 2026-05-27 153612.png>)
...
![alt text](<스크린샷 2026-05-27 165900.png>) ![alt text](<스크린샷 2026-05-27 153612-1.png>)